...
// module
exports.push([module.i, ".wrapperLayer__z_PKn {\n  position: fixed;\n  margin: 0;\n  padding: 0;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: 999;\n}\n", ""]);
 ...
 */
var IS_INITIALIZED = "__ZMAGE_INITIALIZED__";
var IS_DESKTOP = "__ZMAGE_ENV_IS_DESKTOP__";
var IS_MOBILE = "__ZMAGE_ENV_IS_MOBILE__";
...
var default_defPropWithEnv = function defPropWithEnv(preset) {
  if (typeof window !== "undefined") {
    ...
    if (!window[DEF_PROP].hasOwnProperty(preset)) {
      switch (preset) {
        case 'desktop':
          window[DEF_PROP][preset] = default_objectSpread({}, default_defProp, {}, defPreset.desktop);
          break;

        case 'mobile':
          window[DEF_PROP][preset] = default_objectSpread({}, default_defProp, {}, defPreset.mobile);
          break;

        case 'auto':
          window[DEF_PROP][preset] = default_objectSpread({}, default_defProp, {}, env.isDesktop && defPreset.desktop, {}, env.isMobile && defPreset.mobile);
          break;
...
var utils_innerWidth = function innerWidth() {
...
var utils_innerHeight = function innerHeight() {
...
var Image_utils_getCoverStyle = function getCoverStyle(props, context, imageRef, touchProfile) {
  ...
  if (touchProfile && touchProfile.phase === TOUCH_BEHAVIOR_PHASE.END) {
    ...
    return {
      _type: 'cover',
      _behavior: 'merge',
      y: offset.y > 0 ? utils_innerHeight() : -utils_innerHeight()
    };
  }
  ...
  if (coverRef.current) {
    ...
    return pageIsCover ? {
      ...
      y: -utils_innerHeight() / 2 + top + height / 2,
    ...
    return {
      ...
      y: coverPos.y ? coverPos.y - utils_innerHeight() / 2 : 0,
      opacity: 0,
      scale: 0,
      rotate: 0,
      radius: 0
...
var Image_utils_getZoomingStyle = function getZoomingStyle(props, context, imageRef) {
  var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
      ...
      mouseY = _ref$clientY === void 0 ? utils_innerHeight() / 2 : _ref$clientY;
  ...
  var viewHeight = utils_innerHeight();
